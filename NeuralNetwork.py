...
dense1 = LayerDense(4,20)
#dense 2 and 3 create layers of matching shape to dense 1 [1] == [0]
#and use the ReLU activation function
dense2 = LayerDense(20,20)
dense3 = LayerDense(20,20)
dense4 = LayerDense(20,20)
dense5 = LayerDense(20,20)
dense6 = LayerDense(20,20)
dense7 = LayerDense(20,20)
dense8 = LayerDense(20,20)
dense9 = LayerDense(20,20)
#output dense layer uses softmax
dense10 = LayerDense(20,3)
...
optimizer = AdamOptimizer(learningRate = 0.01, decay = 5e-7)
for epoch in range(10001):
    ...
    loss = lossActivation.forward(dense10.output, y)
    ...
    dense10.backward(lossActivation.dinputs)
